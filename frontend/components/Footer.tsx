			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				<div
					...
					<div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
						<h1 className="text-3xl font-bold text-blue-600"><a href={"/"}>Fonote</a></h1>
						...
						<Link href="/contact"
							 className="py-2.5 px-5 h-9 block w-fit bg-blue-600 font-bold rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-blue-700 lg:mx-0">
							Contact us
						</Link>
					</div>
				...
				<div className="py-7 border-t border-gray-200">
					<div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
						<span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">Fonote</a> 2024, All rights reserved.</span>
