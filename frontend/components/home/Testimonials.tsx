      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          <div className="text-center">
            ...
            <h2 className="font-poppins mt-4 text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl">
          ...
          <div className="relative mt-10 md:mt-24 md:order-2">
            <div className="absolute -inset-x-1 inset-y-16 md:-inset-x-2 md:-inset-y-6">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #18c964 -0.55%, #7cf4af 22.86%, #008237 48.36%, #a4ffcb 73.33%, #009841 99.34%)",
                }}
              ></div>
            </div>
                  ...
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 mt-8">
                      <p className="text-lg leading-relaxed text-gray-900 font-pj">
                        ...
                        experience. Thank you for such an incredible solution!””
                      </p>
                    </blockquote>
                  </div>
